...
def main():
    parser = argparse.ArgumentParser(description="Resolves pangenome graph snarls into sub-snarls where reference and"
                                     "alternative paths diverge, then generates dotplot objects (REF2REF, REF2ALT, ALT2ALT)"
                                     "for each and exports them into a compressed .pkl file.")
